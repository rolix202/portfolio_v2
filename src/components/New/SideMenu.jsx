...
const SideMenu = ({ handleClose }) => {
  return (
    <div
      className="fixed inset-0 bg-gradient-to-b from-purple-950 via-purple-900 to-purple-950 text-white z-50 flex flex-col h-screen px-8 py-12 md:hidden transition-transform transform -translate-x-full animate-menuSlideIn"
    >
      {/* Close Icon */}
      ...
      {/* Welcome Message */}
      <div className="mt-6 animate-slideInDelay">
