            ...
            <div className="max-w-6xl mx-auto text-white py-24">
                <div className="grid grid-cols-2 gap-8 items-center">
                    ...
                    <div className="relative h-72 md:h-80 lg:h-96">
                        ...
                        <div className="absolute top-6 left-10 transform -rotate-6 shadow-lg bg-white p-2 z-10">
                            <img
                                src={rooo}
                                alt="My latest pic!"
                                className="w-44 sm:w-52 md:w-36 lg:w-52"
                            />
                            <p className="text-center mt-2 text-gray-600 font-semibold">The Visionary!</p>
                        </div>
                        {/* Second Image - Tilted Left and Lower */}
                        <div className="absolute top-28 left-48 transform rotate-12 shadow-lg bg-white p-2">
                            <img
                                src={codee}
                                alt="My workflow!"
                                className="w-44 sm:w-52 md:w-36 lg:w-52"
